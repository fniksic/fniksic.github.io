...
* **Stream Processing with Dependency-guided Synchronization.**
  ...
  _In Proceedings of the 27th ACM SIGPLAN Symposium on Principles and Practice of Parallel Programming ([PPoPP 2022](https://ppopp22.sigplan.org/))._ April 2022. \\
  [paper](/assets/files/ppopp2022/paper.pdf){: .btn .btn--primary .btn-small}
...
* **Reducing Time-to-Fix for Fuzzer Bugs.**
  [Rui Abreu](https://ruimaranhao.com/),
  [Franjo Ivančić](https://sites.google.com/site/ivancic/),
  [Filip Nikšić](https://fniksic.github.io/),
  Hadi Ravanbakhsh,
  Ramesh Viswanathan.
...
* **Synchronization Schemas.**
  ...
  [Zachary G. Ives](https://www.cis.upenn.edu/~zives/),
  [Konstantinos Kallas](https://angelhof.github.io/),
  [Konstantinos Mamouras](https://kmamouras.github.io/),
  [Filip Niksic](https://fniksic.github.io/),
  [Caleb Stanford](https://web.cs.ucdavis.edu/~cdstanford/),
  [Val Tannen](https://www.cis.upenn.edu/~val/),
  [Anton Xue](https://antonxue.github.io/).
  _In Proceedings of the 40th ACM SIGMOD-SIGACT-SIGAI Symposium on Principles of Database Systems ([**PODS 2021**](https://2021.sigmod.org/))._
  June 2021. \\
  <span>Invited paper (not peer-reviewed)</span> \\
  [paper](/assets/files/pods2021/paper.pdf){: .btn .btn--primary .btn-small}
...
* **Testing Consensus Implementations Using Communication Closure.**
  ...
  [Constantin Enea](http://www.lix.polytechnique.fr/~cenea/),
...
* **Rely/Guarantee Reasoning for Asynchronous Programs.**
  ...
  [Filip Niksic](https://fniksic.github.io/),
  [Aditya Kanade](https://www.microsoft.com/en-us/research/people/kanadeaditya/),
  [Rupak Majumdar](https://people.mpi-sws.org/~rupak/),
